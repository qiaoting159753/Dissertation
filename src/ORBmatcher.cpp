...
namespace Dissertation {
    ...
    const int ORBmatcher::TH_HIGH = 140;
    ...
    bool ORBmatcher::CheckDistEpipolarLine(const cv::KeyPoint &kp1, const cv::KeyPoint &kp2, const cv::Mat &F12, const Frame *pKF2) {
...
//
    ...
    int ORBmatcher::SearchByProjection(Frame &CurrentFrame, const Frame &LastFrame, const float th, const bool bMono) {
        ...
        cout << "lalalal" << endl;
        const bool bForward = tlc.at<float>(2) > CurrentFrame.camera->mb && !bMono;
        const bool bBackward = -tlc.at<float>(2) > CurrentFrame.camera->mb && !bMono;

        cout << "lalalal111" << endl;

        for (int i = 0; i < LastFrame.N; i++) {
            cout << "lalalal222" << endl;
                ...
                if (!LastFrame.mvbOutlier[i]) {
                    ...
                    for (vector<size_t>::const_iterator vit = vIndices2.begin(), vend = vIndices2.end();
                        ...
                        if (CurrentFrame.mvuRight[i2] > 0) {
                            const float ur = u - CurrentFrame.camera->mbf * invzc;
        ...
        if (LastFrame.mDescriptors.empty()) {
            cout << "Old I am empty 1" << endl;
            return nmatches;
        }
        if (CurrentFrame.mDescriptors.empty()) {
            cout << "Old I am empty 2" << endl;
            return nmatches;
        }
