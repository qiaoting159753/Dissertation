...
#ifndef DISSERTATION_ORB_MATCHER_H
#define DISSERTATION_ORB_MATCHER_H
...
namespace Dissertation {
    ...
    public:
        ...
        bool CheckDistEpipolarLine(const cv::KeyPoint &kp1, const cv::KeyPoint &kp2, const cv::Mat &F12, const Frame *pKF2);
        float mfNNratio;
        bool mbCheckOrientation;
    };
}

#endif //DISSERTATION_ORB_MATCHER_H
